...
type StarLayerProps = HTMLMotionProps<"div"> & {
    count?: number; // Optional based on usage in component, but good to be explicit
    size?: number;
    // transition prop is handled by HTMLMotionProps but we can narrow it down if needed or verify compatibility
    starColor?: string;
};
...
export function StarsBackground({
    ...
    return (
        <div
            ...
            {...props}
        >
            {/* Stars Layers container that moves with mouse */}
