...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-black text-white">
            <StarsBackground className="min-h-screen flex items-center justify-center pointer-events-auto">
                <div className="max-w-2xl w-full p-8 space-y-8 animate-in fade-in duration-700 slide-in-from-bottom-10 pointer-events-auto">
                    <h1 className="text-5xl font-serif mb-8 text-center bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">About Me</h1>
